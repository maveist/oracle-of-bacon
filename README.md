...
```
cd ~/Downloads/neo4j-community-3.5.3
rm -rf data/
bin/neo4j-admin import --nodes:Movies ~/Downloads/imdb-data/movies.csv --nodes:Actors ~/Downloads/imdb-data/actors.csv --relationships ~/Downloads/imdb-data/roles.csv
bin/neo4j start
```
